...
class ProductCarousel {
    ...
    handleResize() {
        ...
        this.resizeTimer = setTimeout(() => {
            ...
            if (newCardsPerView !== this.cardsPerView) {
                ...
                // Remover indicadores antiguos si existen
                const oldIndicators = this.section.querySelector('.carousel-indicators');
                if (oldIndicators) {
                    oldIndicators.remove();
                }
                
                // Recrear indicadores si es necesario
                if (this.maxIndex > 0) {
                    this.createIndicators();
                }
            }
    ...
    handleKeyboard(e) {
        // Solo navegar con carrusel activado
